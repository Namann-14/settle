...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@settle/ui/components/collapsible";
...
export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  <CollapsibleTrigger className={cn("size-8", className)} data-slot="plan-trigger" render={<Button size="icon" variant="ghost" />} {...props}><ChevronsUpDownIcon className="size-4" /><span className="sr-only">Toggle plan</span></CollapsibleTrigger>
);
