...
import { useIsMobile } from "@settle/ui/hooks/use-mobile"
...
function SidebarMenuSkeleton({
  ...
  // Varied width between 50 to 90%. Derived from useId rather than
  // Math.random so the server render and hydration agree.
